...
def preview_text(text='A', font_size=100, num_points=500):
    ...
    try:
        ...
        extractor.preview_skeleton_extraction_steps(
            text,
            font_size=font_size,
            save_path=f'preview_skeleton_{text}.png'
        )
...
def compare_different_approaches(text='A'):
    ...
    try:
        ...
        plt.close()  # Close instead of show to avoid warnings
...
if __name__ == '__main__':
    ...
    print("Centerline Preview Tool")
    print("=======================")
    print(f"Text: '{text_to_preview}'")
    print(f"Font size: {font_size}")
    print(f"Points per character: {num_points}")
    print()
    ...
    print("Files created:")
    print(f"- preview_basic_{text_to_preview}.png")
    print(f"- preview_skeleton_{text_to_preview}.png")
    print(f"- comparison_{text_to_preview}.png")
